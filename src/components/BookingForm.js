      ...
      <form onSubmit={handleSubmit}>
        <fieldset>
          ...
          <div>
            ...
            <input type="number" id='book-guests' value={guests} min={1} placeholder="1" onChange={e => setGuests(e.target.value)} required/>
          </div>
          {/* Occasion */}
          <div>
            <label htmlFor="book-occasion">Occasion:</label>
            <select name="" id="book-occasion" value={occasion} onChange={e => setOccasion(e.target.value)} required>
